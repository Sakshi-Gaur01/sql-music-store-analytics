...
FROM customer
JOIN invoice ON customer.customer_id = invoice.customer_id::integer
...
FROM customer
JOIN invoice 
	ON invoice.customer_id::integer = customer.customer_id
JOIN invoice_line
...
FROM invoice i
JOIN customer c ON c.customer_id = i.customer_id::integer
...
(
	...
	JOIN customer
		ON customer.customer_id = invoice.customer_id::integer
	JOIN track 
		ON track.track_id = invoice_line.track_id
	JOIN genre 
		ON genre.genre_id = track.genre_id
...
(
	...
	FROM invoices
	JOIN customer ON customer.customer_id = invoice.customer_id::integer
	GROUP BY 1,2,3,4
